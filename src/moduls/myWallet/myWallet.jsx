...
function MyWallet() {
    ...
    const toReplenish = async (e) => {
        ...
        const myAccaunt = JSON.parse(localStorage.getItem('myAccaunt'));
        fetch(`https://nftmarket.pythonanywhere.com/api/v1/get_money_binace/${myAccaunt.binance.id}/`, {
            method: 'POST',
            headers: {
            ...
            .catch(err => {
                ...
                alert('Error in transferring funds, please try later')
            })
    }
                    ...
                    <div className='wallet'>
                        <div className="wallet-about">
                            <div className="content">
                                <h2><img src="/wallet/binance.svg" alt="binance" />Binance</h2>
                                <img src={me.binance.avatar} alt="avatar" />
